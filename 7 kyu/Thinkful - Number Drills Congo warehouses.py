...
warehouses that you use to store your frozen pizzas, and you need to figure out how many crates of pizzas 
you can store at each location.
...
you can fit 24 boxes across, 48 boxes deep, and 12 boxes high, so box_capacity(32, 64, 16) should return 13824.
```

def box_capacity(length, width, height):
    return (length // 1.33) * (width // 1.33) * (height // 1.33)    