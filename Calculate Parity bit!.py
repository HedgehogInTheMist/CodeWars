...
You have two parameters, one being the wanted parity (always 'even' or 'odd'), and the other being the binary 
...
def check_parity(parity: str, bin_str: str) -> int: 
    is_even = not bin_str.count('1') % 2

    if parity == 'even' and not is_even:
        return 1
    elif parity == 'odd' and is_even:
        return 1
    else:
        return 0